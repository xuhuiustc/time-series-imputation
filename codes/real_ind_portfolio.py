...
#generating mask --- MAR
#def missing(miss_prob1=0.2, miss_prob2=0.5):
    #''True'' represents missing
...
for k in range(n_experiment):
   ...
   # sharper_i_nomissing[k], sharper_o_nomissing[k], mreturn_i_nomissing[k], mreturn_o_nomissing[k] = Greedy(data)
    
    
    for i in range(num_delta):
        #print(i)
        _,final_mu,final_sigma = consensuscforwardkl(meanlist,covariancelist,deltalist_complex[i],meanlist[0])
